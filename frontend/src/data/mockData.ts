...
const AREA_SEEDS: AreaSeed[] = [
  { name: "Alpena", state: "Michigan", lat: 45.06, lng: -83.43, population: 26937, specialty: "Cardiology", supply: 5, riskScore: 31, travelKm: 20.7 },
  { name: "Hillsdale", state: "Michigan", lat: 41.92, lng: -84.63, population: 6068, specialty: "Endocrinology", supply: 5, riskScore: 30, travelKm: 6.7 },
  { name: "Pigeon", state: "Michigan", lat: 43.83, lng: -83.27, population: 33970, specialty: "Oncology", supply: 5, riskScore: 94, travelKm: 23.6 },
  { name: "Bellaire", state: "Michigan", lat: 44.98, lng: -85.2, population: 6100, specialty: "Neurology", supply: 3, riskScore: 43, travelKm: 9.0 },
  { name: "Oscoda", state: "Michigan", lat: 44.43, lng: -83.32, population: 26083, specialty: "Psychiatry", supply: 1, riskScore: 45, travelKm: 11.9 },
  { name: "Daggett", state: "Michigan", lat: 45.47, lng: -87.61, population: 34801, specialty: "Pulmonary", supply: 1, riskScore: 54, travelKm: 37.5 },
  { name: "Harrisville", state: "Michigan", lat: 44.65, lng: -83.29, population: 4775, specialty: "Rheumatology", supply: 1, riskScore: 58, travelKm: 36.1 },
  { name: "Kalkaska", state: "Michigan", lat: 44.73, lng: -85.18, population: 13222, specialty: "Cardiology", supply: 5, riskScore: 59, travelKm: 28.4 },
  { name: "Goldsboro", state: "North Carolina", lat: 35.38, lng: -77.99, population: 15589, specialty: "Endocrinology", supply: 3, riskScore: 79, travelKm: 27.0 },
  { name: "Rocky Mount", state: "North Carolina", lat: 35.94, lng: -77.8, population: 40431, specialty: "Oncology", supply: 3, riskScore: 38, travelKm: 19.7 },
  { name: "Louisburg", state: "North Carolina", lat: 36.1, lng: -78.3, population: 41495, specialty: "Neurology", supply: 3, riskScore: 34, travelKm: 35.7 },
  { name: "Rutherfordton", state: "North Carolina", lat: 35.37, lng: -81.96, population: 37163, specialty: "Psychiatry", supply: 1, riskScore: 55, travelKm: 11.1 },
  { name: "Clinton", state: "North Carolina", lat: 35, lng: -78.32, population: 14753, specialty: "Pulmonary", supply: 1, riskScore: 46, travelKm: 41.8 },
  { name: "Lexington", state: "North Carolina", lat: 35.82, lng: -80.25, population: 11374, specialty: "Rheumatology", supply: 3, riskScore: 35, travelKm: 19.0 },
  { name: "Boone", state: "North Carolina", lat: 36.22, lng: -81.67, population: 8293, specialty: "Cardiology", supply: 3, riskScore: 51, travelKm: 39.3 },
  { name: "Waxhaw", state: "North Carolina", lat: 34.92, lng: -80.74, population: 32839, specialty: "Endocrinology", supply: 1, riskScore: 75, travelKm: 11.0 },
  { name: "Matthews", state: "North Carolina", lat: 35.12, lng: -80.72, population: 15954, specialty: "Oncology", supply: 5, riskScore: 30, travelKm: 32.6 },
  { name: "Monroe", state: "North Carolina", lat: 34.98, lng: -80.55, population: 22444, specialty: "Neurology", supply: 4, riskScore: 64, travelKm: 35.3 },
  { name: "Troy", state: "North Carolina", lat: 35.36, lng: -79.9, population: 35623, specialty: "Psychiatry", supply: 2, riskScore: 78, travelKm: 23.6 },
  { name: "Dunn", state: "North Carolina", lat: 35.31, lng: -78.61, population: 40314, specialty: "Pulmonary", supply: 1, riskScore: 31, travelKm: 17.5 },
  { name: "Lumberton", state: "North Carolina", lat: 34.62, lng: -79.01, population: 30217, specialty: "Rheumatology", supply: 1, riskScore: 88, travelKm: 11.9 },
  { name: "Washington", state: "North Carolina", lat: 35.55, lng: -77.05, population: 23471, specialty: "Cardiology", supply: 3, riskScore: 75, travelKm: 21.8 },
  { name: "Lenoir", state: "North Carolina", lat: 35.91, lng: -81.54, population: 20724, specialty: "Endocrinology", supply: 5, riskScore: 33, travelKm: 15.4 },
  { name: "Whiteville", state: "North Carolina", lat: 34.33, lng: -78.7, population: 7059, specialty: "Oncology", supply: 1, riskScore: 60, travelKm: 18.2 },
  { name: "Roxboro", state: "North Carolina", lat: 36.39, lng: -78.98, population: 20654, specialty: "Neurology", supply: 2, riskScore: 76, travelKm: 24.1 },
  { name: "Saluda", state: "North Carolina", lat: 35.23, lng: -82.34, population: 22869, specialty: "Psychiatry", supply: 1, riskScore: 92, travelKm: 39.2 },
  { name: "Jackson", state: "North Carolina", lat: 36.39, lng: -77.42, population: 12758, specialty: "Pulmonary", supply: 4, riskScore: 42, travelKm: 31.0 },
  { name: "Edenton", state: "North Carolina", lat: 36.06, lng: -76.61, population: 40293, specialty: "Rheumatology", supply: 3, riskScore: 91, travelKm: 29.5 },
  { name: "Pollocksville", state: "North Carolina", lat: 35, lng: -77.22, population: 16792, specialty: "Cardiology", supply: 5, riskScore: 52, travelKm: 35.7 },
  { name: "Yanceyville", state: "North Carolina", lat: 36.4, lng: -79.33, population: 26138, specialty: "Endocrinology", supply: 5, riskScore: 70, travelKm: 38.0 },
  { name: "Harker Heights", state: "Texas", lat: 31.06, lng: -97.66, population: 31030, specialty: "Oncology", supply: 2, riskScore: 57, travelKm: 7.9 },
  { name: "Belton", state: "Texas", lat: 31.06, lng: -97.46, population: 35328, specialty: "Neurology", supply: 1, riskScore: 50, travelKm: 6.0 },
  { name: "Laredo", state: "Texas", lat: 27.51, lng: -99.51, population: 9220, specialty: "Psychiatry", supply: 2, riskScore: 59, travelKm: 13.4 },
  { name: "Gun Barrel City", state: "Texas", lat: 32.33, lng: -96.15, population: 30392, specialty: "Pulmonary", supply: 3, riskScore: 44, travelKm: 41.3 },
  { name: "Willow Park", state: "Texas", lat: 32.79, lng: -97.65, population: 29924, specialty: "Rheumatology", supply: 1, riskScore: 32, travelKm: 30.3 },
  { name: "Weatherford", state: "Texas", lat: 32.76, lng: -97.8, population: 28011, specialty: "Cardiology", supply: 3, riskScore: 65, travelKm: 23.4 },
  { name: "Sherman", state: "Texas", lat: 33.64, lng: -96.61, population: 41539, specialty: "Endocrinology", supply: 1, riskScore: 41, travelKm: 33.2 },
  { name: "Marshall", state: "Texas", lat: 32.54, lng: -94.37, population: 41953, specialty: "Oncology", supply: 3, riskScore: 32, travelKm: 23.0 },
  { name: "Granbury", state: "Texas", lat: 32.44, lng: -97.79, population: 26377, specialty: "Neurology", supply: 1, riskScore: 80, travelKm: 9.4 },
  { name: "Three Rivers", state: "Texas", lat: 28.46, lng: -98.18, population: 39940, specialty: "Psychiatry", supply: 4, riskScore: 33, travelKm: 30.8 },
  { name: "Corsicana", state: "Texas", lat: 32.1, lng: -96.47, population: 8742, specialty: "Pulmonary", supply: 2, riskScore: 34, travelKm: 12.8 },
  { name: "Rockwall", state: "Texas", lat: 32.93, lng: -96.46, population: 18586, specialty: "Rheumatology", supply: 5, riskScore: 73, travelKm: 28.4 },
  { name: "Greenville", state: "Texas", lat: 33.14, lng: -96.11, population: 31845, specialty: "Cardiology", supply: 2, riskScore: 91, travelKm: 13.4 },
  { name: "Floresville", state: "Texas", lat: 29.13, lng: -98.16, population: 22222, specialty: "Endocrinology", supply: 2, riskScore: 83, travelKm: 17.5 },
  { name: "Jourdanton", state: "Texas", lat: 28.91, lng: -98.55, population: 33596, specialty: "Oncology", supply: 1, riskScore: 54, travelKm: 28.0 },
  { name: "Cleveland", state: "Texas", lat: 30.34, lng: -95.09, population: 5852, specialty: "Neurology", supply: 1, riskScore: 31, travelKm: 26.7 },
  { name: "Fulshear", state: "Texas", lat: 29.69, lng: -95.89, population: 16836, specialty: "Psychiatry", supply: 4, riskScore: 78, travelKm: 21.3 },
  { name: "Boerne", state: "Texas", lat: 29.79, lng: -98.73, population: 32718, specialty: "Pulmonary", supply: 5, riskScore: 65, travelKm: 30.5 },
  { name: "Gainesville", state: "Texas", lat: 33.63, lng: -97.13, population: 25041, specialty: "Rheumatology", supply: 4, riskScore: 67, travelKm: 32.4 },
  { name: "Canyon Lake", state: "Texas", lat: 29.87, lng: -98.26, population: 30435, specialty: "Cardiology", supply: 2, riskScore: 72, travelKm: 30.4 },
  { name: "Alice", state: "Texas", lat: 27.75, lng: -98.07, population: 22045, specialty: "Endocrinology", supply: 4, riskScore: 28, travelKm: 12.2 },
  { name: "Tenaha", state: "Texas", lat: 31.95, lng: -94.24, population: 13403, specialty: "Oncology", supply: 2, riskScore: 35, travelKm: 6.1 },
  { name: "Clifton", state: "Texas", lat: 31.78, lng: -97.58, population: 30636, specialty: "Neurology", supply: 5, riskScore: 83, travelKm: 29.2 },
  { name: "Gonzales", state: "Texas", lat: 29.5, lng: -97.45, population: 26915, specialty: "Psychiatry", supply: 3, riskScore: 41, travelKm: 33.0 },
  { name: "Bay City", state: "Texas", lat: 28.98, lng: -95.97, population: 37893, specialty: "Pulmonary", supply: 3, riskScore: 55, travelKm: 41.4 },
  { name: "Fort Stockton", state: "Texas", lat: 30.89, lng: -102.88, population: 7256, specialty: "Rheumatology", supply: 3, riskScore: 84, travelKm: 10.0 },
  { name: "Pampa", state: "Texas", lat: 35.53, lng: -100.96, population: 19770, specialty: "Cardiology", supply: 2, riskScore: 48, travelKm: 41.3 },
  { name: "Columbus", state: "Texas", lat: 29.71, lng: -96.55, population: 5102, specialty: "Endocrinology", supply: 5, riskScore: 80, travelKm: 24.7 },
  { name: "Brenham", state: "Texas", lat: 30.17, lng: -96.4, population: 20830, specialty: "Oncology", supply: 5, riskScore: 54, travelKm: 18.0 },
];
...
export const SPECIALTY_TO_DISEASE: Record<Specialty, Disease> = {
